...
(function(){
  ...
  UnobtrusiveFlash.showFlashMessage = function(message, options) {
    ...
    var $flash = $('<div class="unobtrusive-flash-message-wrapper unobtrusive-flash-'+options.type+'"><div class="unobtrusive-flash-message">'+message+'</div>
                   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">ok;</span></button></div>');
